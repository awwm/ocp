		...
		<fieldset>
			...
			<div class="results">
				<div class="expected-winnings">
					<span><?php esc_html_e( 'Expected Winnings', 'ocbc' ); ?></span>
					<span>
						<div class="result-values">
							<sup><?php esc_html_e( '$', 'ocbc' ); ?></sup>
							<span id="winning" class="results"></span>
						</div>
					</span>
				</div>
				<div class="expected-payout">
					<span><?php esc_html_e( 'Expected Payout', 'ocbc' ); ?></span>
					<span>
						<div class="result-values">
							<sup><?php esc_html_e( '$', 'ocbc' ); ?></sup>
							<span id="payout" class="results"></span>
						</div>
					</span>
				</div>
			</div>
