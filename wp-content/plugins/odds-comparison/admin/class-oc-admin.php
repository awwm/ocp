...
class Oc_Admin {
	...
	public function addPluginAdminMenu() {
		...
		add_menu_page(  $this->plugin_name, 'Odds Comparison', 'administrator', $this->plugin_name, array( $this, 'displayPluginAdminSettings' ), 'dashicons-chart-area', 26 );
	}
	...
	public function displayPluginAdminSettings() {
		...
		if(isset($_GET['error_message'])){
			add_action('admin_notices', array($this,'pluginAdminSettingsMessages'));
			do_action( 'admin_notices', $_GET['error_message'] );
		}
		require_once 'partials/'.$this->plugin_name.'-admin-display.php';
	}

	public function pluginAdminSettingsMessages($error_message){
		switch ($error_message) {
			case '1':
				$message = __( 'There was an error adding this setting. Please try again.  If this persists, shoot us an email.', 'oc' );                 
				$err_code = esc_attr( 'oc_admin_setting' );                 
				$setting_field = 'oc_admin_setting';                 
			break;
		}
		$type = 'error';
		add_settings_error(
	...
	public function registerAndBuildFields() {
		...
		add_settings_section(
			...
			array( $this, 'oc_display_general_account' ),    
		...
		add_settings_field(
			'oc_admin_setting',
			'Test Input',
			array( $this, 'oc_render_settings_field' ),
			'oc_general_settings',
			'oc_general_section',
			$args
		);
	...
	public function oc_display_general_account() {
		echo '<p>These settings apply to all Odds Comparison Plugin functionality.</p>';
	}

	public function oc_render_settings_field($args) {  
